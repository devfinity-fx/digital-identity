...
namespace SwingWERX.Extensions
{
    static class GraphicsExtension
    {
        ...
        public static GraphicsPath GetRoundPath(Rectangle r, int depth)
        {
            ...
            graphPath.AddArc(r.X, r.Y, depth, depth, 180, 90); // top left
            graphPath.AddArc(r.X + r.Width - depth, r.Y, depth, depth, 270, 90); // top right
            graphPath.AddArc(r.X + r.Width - depth, r.Y + r.Height - depth, depth, depth, 0, 90); // bottom right
            graphPath.AddArc(r.X, r.Y + r.Height - depth, depth, depth, 90, 90); // bottom left
            graphPath.AddLine(r.X, r.Y + r.Height - depth, r.X, r.Y + depth / 2); // line sa left.
