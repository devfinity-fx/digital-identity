...
{
    public partial class OfficeButton : Button
    {
        #region Fields

        private SwingWERX.Controls.Theme thm = SwingWERX.Controls.Theme.OfficeBlue;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (thm == SwingWERX.Controls.Theme.OfficeBlue || thm == SwingWERX.Controls.Theme.OfficeGreen || thm == SwingWERX.Controls.Theme.OfficeYellow || thm == SwingWERX.Controls.Theme.OfficePublisher ||
                thm == SwingWERX.Controls.Theme.OfficeRed || thm == SwingWERX.Controls.Theme.OfficeWhite || thm == SwingWERX.Controls.Theme.OfficePink)
            {
        ...
        public SwingWERX.Controls.Theme Theme
        {
            get
            {
                if (this.ColorTable == ColorTable.Office2010Green)
                {
                    return SwingWERX.Controls.Theme.OfficeGreen;
                }
                else if (this.ColorTable == ColorTable.Office2010Red)
                {
                    return SwingWERX.Controls.Theme.OfficeRed;
                }
                else if (this.ColorTable == ColorTable.Office2010Pink)
                {
                    return SwingWERX.Controls.Theme.OfficePink;
                }
                else if (this.ColorTable == ColorTable.Office2010Yellow)
                {
                    return SwingWERX.Controls.Theme.OfficeYellow;
                }
                else if (this.ColorTable == ColorTable.Office2010White)
                {
                    return SwingWERX.Controls.Theme.OfficeWhite;
                }
                else if (this.ColorTable == ColorTable.Office2010Publisher)
                {
                    return SwingWERX.Controls.Theme.OfficePublisher;
                }

                return SwingWERX.Controls.Theme.OfficeBlue;
            }
            ...
            set
            {
                ...
                if (thm == SwingWERX.Controls.Theme.OfficeGreen)
                {
                    this.ColorTable = ColorTable.Office2010Green;
                }
                else if (thm == SwingWERX.Controls.Theme.OfficeRed)
                {
                    this.ColorTable = ColorTable.Office2010Red;
                }
                else if (thm == SwingWERX.Controls.Theme.OfficePink)
                {
                    this.ColorTable = ColorTable.Office2010Pink;
                }
                else if (thm == SwingWERX.Controls.Theme.OfficeWhite)
                {
                    this.ColorTable = ColorTable.Office2010White;
                }
                else if (thm == SwingWERX.Controls.Theme.OfficeYellow)
                {
                    this.ColorTable = ColorTable.Office2010Yellow;
                }
                else if (thm == SwingWERX.Controls.Theme.OfficePublisher)
                {
