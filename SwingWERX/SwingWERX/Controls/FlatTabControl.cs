...
namespace SwingWERX.Controls
{
    ...
    public class FlatTabControl : System.Windows.Forms.TabControl
    {
        ...
        private int HoveredTabIndex { get; set; }
        ...
        */
        ...
        private void Page_MouseEnter(object sender, EventArgs e)
        {
            Invalidate();
        }
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            {
                Rectangle lineRect = new Rectangle(recBounds.X, recBounds.Y, recBounds.Width - 4, recBounds.Height);
                g.DrawRectangle(SystemPens.ControlDark, lineRect);
                //----------------------------
                // clear bottom lines
                ...
                switch (this.Alignment)
                {
                    case TabAlignment.Top:
                        g.DrawLine(pen, recBounds.Left + 1, recBounds.Bottom, recBounds.Right - 5, recBounds.Bottom);
                        g.DrawLine(pen, recBounds.Left + 1, recBounds.Bottom + 1, recBounds.Right - 5, recBounds.Bottom + 1);
                        break;
